...
class NeighborFinder:
    ...
    def find_before(self, src_idx, cut_time, static=False):
        """
    ...
    def get_temporal_neighbor(self, src_idx_l, cut_time_l, num_neighbors=20, static=False):
        """
        Params
        ------
        src_idx_l: List[int]
        ...
        for i, (src_idx, cut_time) in enumerate(zip(src_idx_l, cut_time_l)):
            ngh_idx, ngh_eidx, ngh_ts = self.find_before(src_idx, cut_time, static)
